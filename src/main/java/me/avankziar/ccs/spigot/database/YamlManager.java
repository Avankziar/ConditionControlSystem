...
public class YamlManager
{
	...
	public YamlManager()
	{
		initConfig();
		initCommands();
		initConditonBonusMalusLanguage();
		initLanguage();
	}
	...
	public void initConditonBonusMalusLanguage() //INFO:BonusMalusLanguages
	{
		/*cbmlanguageKeys.put(Bypass.Permission.BASE.toString()+".Displayname",
				new Language(new ISO639_2B[] {ISO639_2B.GER, ISO639_2B.ENG}, new Object[] {
						"&eByasspermission für",
						"&eBypasspermission for"}));
		cbmlanguageKeys.put(Bypass.Permission.BASE.toString()+".Explanation",
				new Language(new ISO639_2B[] {ISO639_2B.GER, ISO639_2B.ENG}, new Object[] {
						"&eByasspermission für",
